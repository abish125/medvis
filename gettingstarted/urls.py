...
urlpatterns = patterns('',
    ...
    url(r'^g2', hello.views.g2, name='g2'),
    url(r'^gt3', hello.views.gt3, name='gt3'),
    url(r'^teach/', hello.views.teach, name='teach'),
    url(r'^t2/', hello.views.t2, name='t2'),
    ...
    url(r'training2/', hello.views.training2, name='training2'),
    ...
    url(r'^health_data/', hello.views.health_data, name='health_data')
)

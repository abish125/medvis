...
new_search = input("what is the next word")

fname  = new_search + "_" + web + ".txt"
...
if os.path.isfile(fname):
		...
		f = open(fname, 'w')
		cmd = ['casperjs search_' + web + '.js \'' + s + '\''] #, 'args']
		new_text = subprocess.check_output(cmd, shell=True, stderr=subprocess.STDOUT)
		f.write(text)
...
if answer == "y":
	...
	if answer == "bodypart" || answer == "organ" || answer == "specialty"
		searches = searches + [new_search]
